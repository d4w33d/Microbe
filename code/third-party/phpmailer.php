 ...
 */
interface Microbe_PHPMailer_OAuthTokenProvider
{
    public function getOauth64();
}
class Microbe_PHPMailer_OAuth implements Microbe_PHPMailer_OAuthTokenProvider
{
    protected $provider;
    ...
    {
        if (!class_exists('\League\OAuth2\Client\Grant\RefreshToken')) throw new Exception("[PHPMailer] Missing class RefreshToken");
...
class Microbe_PHPMailer_SMTP
{
    ...
    protected function edebug($str, $level = 0)
    {
        ...
        if (!class_exists('\Psr\Log\LoggerInterface')) $this->Debugoutput = 'echo';
    ...
    public function xclient(array $vars)
    {
        ...
        foreach ($vars as $key => $value) {
            if (!class_exists('SMTP')) throw new Exception("[PHPMailer] Missing class SMTP");
...
class Microbe_PHPMailer_PHPMailer
{
    ...
    public function getSMTPInstance()
    {
        if (!is_object($this->smtp)) {
            $this->smtp = new Microbe_PHPMailer_SMTP();
        }
        return $this->smtp;
    }
    public function setSMTPInstance(Microbe_PHPMailer_SMTP $smtp)
    {
        $this->smtp = $smtp;
        return $this->smtp;
    }
    ...
    public function setOAuth(Microbe_PHPMailer_OAuthTokenProvider $oauth)
    {
        $this->oauth = $oauth;
    }
}
